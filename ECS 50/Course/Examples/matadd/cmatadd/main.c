...
int main(int argc, char **argv){
	...
	if(argc < 3){
		printf("matsum.out matrix_A_File matrix_B_File\n");
	...
	mat_c = matadd(mat_a, mat_b, rows_mat_a, cols_mat_a);
	
	//display matrices
	displayMat(mat_a, rows_mat_a, cols_mat_a);
	printf("\n");
	displayMat(mat_b, rows_mat_b, cols_mat_b);
	printf("\n");
	displayMat(mat_c, rows_mat_a, cols_mat_a);
